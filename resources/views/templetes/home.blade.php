...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/')}}">Mittel Admin</a>
        </div>
        <!-- Top Menu Items -->
        <ul class="nav navbar-right top-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-envelope"></i> E-mails</a>
                    </li>
                    <li>
            ...
            <ul class="nav navbar-nav side-nav">
                <li>
                    ...
                    <ul id="demo" class="collapse">
                        <li>
                            <a href="{{url('usuarios/listar')}}">Listar Alunos Cadastrados</a>
                        </li>
                        <li>
                            <a href="#">Listar Cadastros Incompletos</a>
                        </li>
                    </ul>
                </li>
                {{--<li class="active">--}}
